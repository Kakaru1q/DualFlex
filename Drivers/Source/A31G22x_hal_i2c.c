...
/*********************************************************************//**
* @brief         I2C SCL Low Interval delay value functions
* @param[in]     I2Cx    I2C peripheral selected, should be:
*                        - I2C0    :I2C0 peripheral
*                        - I2C1    :I2C1 peripheral
*                        - I2C2    :I2C2 peripheral
* @param[in]     interval    I2C_SCLL_INTERVAL_Type
*                        - SCLL_BY_1    : SCLL*1 interval time
*                        - SCLL_BY_2    : SCLL*2 interval time
*                        - SCLL_BY_4    : SCLL*4 interval time
*                        - SCLL_BY_8    : SCLL*8 interval time
* @return         None
**********************************************************************/
void HAL_I2C_SetSclInterval(I2C_Type *I2Cx, I2C_SCLL_INTERVAL_Type interval) {
    I2Cx->CR &= ~(I2C_CR_INTERVAL_Msk);
    I2Cx->CR |= ((interval & I2C_CR_INTERVAL_MASK) << I2C_CR_INTERVAL_Pos);
}
